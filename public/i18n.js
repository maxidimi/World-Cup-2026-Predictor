(() => {
  ...
  const greek = {
    ...
    "Group-stage predictions": "Προβλέψεις φάσης ομίλων",
    "Control whether users can change group rankings and best third-place qualifiers.": "Έλεγξε αν οι χρήστες μπορούν να αλλάζουν την κατάταξη ομίλων και τις καλύτερες τρίτες ομάδες.",
    "Unlocked": "Ξεκλείδωτο",
    "Unlock predictions": "Ξεκλείδωμα προβλέψεων",
    "Lock predictions": "Κλείδωμα προβλέψεων",
    "Group-stage predictions locked.": "Οι προβλέψεις φάσης ομίλων κλειδώθηκαν.",
    "Group-stage predictions unlocked.": "Οι προβλέψεις φάσης ομίλων ξεκλειδώθηκαν.",
    "Group-stage predictions are locked by the administrator.": "Οι προβλέψεις φάσης ομίλων έχουν κλειδωθεί από τον διαχειριστή.",
